...
const STRIPE_PUBLISHABLE_KEY = 'pk_test_trtrMylnHzOP2kEq8CZMJ0Fh00UaIbTxYW';
...
export default class AddSubscription extends React.Component {
    ...
    onSubmit = async (creditCardInput) => {
        ...
        console.log('ccInput', creditCardInput)
        let creditCardToken;
        try {
            ...
            const response = await axios.post('https://stripeapi-e8d02.web.app/checkout', {
